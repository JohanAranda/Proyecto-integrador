...
import ProductoImagenes from "../components/Producto/ProductoComponents/ProductoImagenes";
...
test("Renderizado Icono Compartir", () => {
    view = render(
        <BrowserRouter>
